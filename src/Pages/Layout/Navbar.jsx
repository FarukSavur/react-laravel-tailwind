            ...
            <div className={classNames({
                ...
                <nav className={classNames({
                    ...
                    <div className='py-2 px-1 mb-auto overflow-auto'>
                        ...
                        <ul className='p-2'>
                            <li>
                                <NavLink to='/' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <IoHome size={20} />
                                    Anasayfa
                            ...
                            <li>
                                <NavLink to='akis-fotograflar' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <FaPanorama size={20} />
                                    Akış fotoğraflar
                            ...
                            <li>
                                <NavLink to='akis-gonderiler' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <LuText size={20} />
                                    Akış Gönderiler
                            ...
                            <li>
                                <NavLink to='mesajlar' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <MdMessage size={20} />
                                    Mesajlar
                            ...
                            <li>
                                <NavLink to='sehrimdeki-ogrenciler' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <FaCity size={20} />
                            ...
                            <li>
                                <NavLink to='makaleler' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                            ...
                            <li>
                                <NavLink to='kampus-sozluk' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                            ...
                            <li>
                                <NavLink to='kampus-sohbet' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                            ...
                            <li>
                                <NavLink to='bilgi-yarismasi' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                            ...
                            <li>
                                <NavLink to='ozgecmis-hazirla' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                            ...
                            <li>
                                <NavLink to='esya-al-sat' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
                                    <BsShop size={20} />
                                    Eşya Al & Sat
                            ...
                            <li>
                                <NavLink to='is-ilanlari' className='menu-item' onClick={() => {
                                    setIsMenuOpen(() => !isMenuOpen)
                                }}>
